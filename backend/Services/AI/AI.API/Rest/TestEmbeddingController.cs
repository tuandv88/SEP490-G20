...
//            var d = await _kernelMemory.ImportDocumentAsync(file.OpenReadStream(), file.FileName, Guid.NewGuid().ToString());
//            return Ok(d);
//        }
//        [HttpPost("/markdown")]
...
//            //SearchClient
//            var answer = await _kernelMemory.SearchAsync(question, minRelevance: 0.5);
