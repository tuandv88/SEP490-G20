...
namespace Learning.Infrastructure.Data.Migrations
{
    ...
    [Migration("20241020154304_InitialCreate")]
            ...
            modelBuilder.Entity("Learning.Domain.Models.ProblemSubmission", b =>
                {
                    ...
                    b.Property<DateTime>("SubmissionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 10, 20, 15, 43, 4, 160, DateTimeKind.Utc).AddTicks(9562));
            ...
            modelBuilder.Entity("Learning.Domain.Models.QuizSubmission", b =>
                {
                    ...
                    b.Property<DateTime>("SubmissionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 10, 20, 15, 43, 4, 171, DateTimeKind.Utc).AddTicks(9922));
            ...
            modelBuilder.Entity("Learning.Domain.Models.UserCourse", b =>
                {
                    ...
                    b.Property<DateTime>("EnrollmentDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 10, 20, 15, 43, 4, 177, DateTimeKind.Utc).AddTicks(4557));
