...
import BasicInfoStep from '@/pages/Problem/ProblemAlgorithm/Update/basic-info-step'
import CodeEditor from '@/pages/Problem/ProblemAlgorithm/Update/CodeEditor'
import Template from '@/pages/Problem/ProblemAlgorithm/Update/Template';
