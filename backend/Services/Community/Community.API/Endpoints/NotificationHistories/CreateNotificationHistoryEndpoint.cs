...
public class CreateNotificationHistoryEndpoint : ICarterModule
{
    ...
    {
        app.MapPost("/notificationhistory/create", async (CreateNotificationHistoryDto createNotificationHistoryDto, ISender sender) =>
        {
            ...
            {
                return Results.BadRequest(new { Message = "Notification history created failed" });
            }
