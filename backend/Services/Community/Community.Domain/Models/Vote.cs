namespace Community.Domain.Models
{
    ...
    {
        public DiscussionId? DiscussionId { get; set; }            // ID của thảo luận được vote (có thể null nếu là vote cho bình luận)
        public CommentId? CommentId { get; set; }                  // ID của bình luận được vote (có thể null nếu là vote cho thảo luận)
