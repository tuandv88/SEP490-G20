...
public class GetCourseProgressHandler(IUserCourseRepository repository, IUserContextService userContext) : IQueryHandler<GetCourseProgressQuery, GetCourseProgressResult> {
