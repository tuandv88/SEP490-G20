...
namespace Learning.Infrastructure.Data.Migrations
{
    ...
    [Migration("20241115141148_InitialOutbox")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Learning.Domain.Models.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Learning.Domain.Models.ProblemSubmission", b =>
                {
                    ...
                    b.Property<DateTime>("SubmissionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 11, 15, 14, 11, 47, 454, DateTimeKind.Utc).AddTicks(7576));
            ...
            modelBuilder.Entity("Learning.Domain.Models.QuizSubmission", b =>
                {
                    ...
                    b.Property<DateTime>("SubmissionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 11, 15, 14, 11, 47, 465, DateTimeKind.Utc).AddTicks(4822));
            ...
            modelBuilder.Entity("Learning.Domain.Models.UserCourse", b =>
                {
                    ...
                    b.Property<DateTime>("EnrollmentDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 11, 15, 14, 11, 47, 469, DateTimeKind.Utc).AddTicks(7562));
