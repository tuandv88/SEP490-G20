            ...
            <Card className='h-[500px] flex flex-col overflow-hidden bg-card transition-all hover:shadow-lg'>
              ...
              <CardContent className='p-4 flex flex-col flex-1'>
                ...
                <button
                  ...
                  className='w-full bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 transition-colors flex items-center justify-center gap-2 font-medium mt-4'
                >
                  View Course
