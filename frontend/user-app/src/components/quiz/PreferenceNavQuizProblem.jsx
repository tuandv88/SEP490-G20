...
const PreferenceNavQuizProblem = ({ onSubmit, loading }) => {
  const codeRunQuiz = useStore((state) => state.codeRunQuiz)

  const handleFetchData = () => {
    alert(`Dữ liệu từ Component Test: ${codeRunQuiz}`)
  }
...
export default PreferenceNavQuizProblem
