...
const quizSchema = z.object({
    ...
    passingMark: z.coerce.number().int("Passing mark must be an integer").min(1, "Passing mark must be a non-negative integer"),
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="grid gap-2">
                  ...
                  <Controller
                    ...
                    control={control}
                    render={({ field }) => (
                      <Input {...field} id="passingMark" type="number" />
                    )}
                  />
                  {errors.passingMark && (
                    <p className="text-sm text-red-500">{errors.passingMark.message}</p>
                  )}
                </div>
              </div>
                  ...
                  {hasTimeLimit && (
                    <div className="grid gap-2">
                      ...
                      <Controller
                        ...
                        control={control}
                        render={({ field }) => (
                          <Input {...field} id="timeLimit" type="number" />
                        )}
                      />
                      {errors.timeLimit && (
                  ...
                  {hasAttemptLimit && (
                    <div className="grid gap-2">
                      ...
                      <Controller
                        ...
                        control={control}
                        render={({ field }) => (
                          <Input {...field} id="attemptLimit" type="number" />
                        )}
                      />
                      {errors.attemptLimit && (
                        <p className="text-sm text-red-500">{errors.attemptLimit.message}</p>
                      )}
                    </div>
                  )}
                </div>
