...
namespace Learning.Infrastructure.Data.Migrations
{
    ...
    [Migration("20241121014332_UpdateFiled")]
            ...
            modelBuilder.Entity("Learning.Domain.Models.ProblemSubmission", b =>
                {
                    ...
                    b.Property<DateTime>("SubmissionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 11, 21, 1, 43, 31, 638, DateTimeKind.Utc).AddTicks(2638));
            ...
            modelBuilder.Entity("Learning.Domain.Models.QuizSubmission", b =>
                {
                    ...
                    b.Property<DateTime>("StartTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 11, 21, 1, 43, 31, 658, DateTimeKind.Utc).AddTicks(2154));
                    ...
                    b.Property<DateTime>("SubmissionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 11, 21, 1, 43, 31, 658, DateTimeKind.Utc).AddTicks(2893));
            ...
            modelBuilder.Entity("Learning.Domain.Models.UserCourse", b =>
                {
                    ...
                    b.Property<DateTime>("EnrollmentDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 11, 21, 1, 43, 31, 665, DateTimeKind.Utc).AddTicks(6332));
