...
const TestcaseInterfaceQuiz = ({ response, loading, testCase }) => {
  const [activeTab, setActiveTab] = useState('Testcase')
  const [activeTestCase, setActiveTestCase] = useState(0)
  const [activeTestResult, setActiveTestResult] = useState(0)
  const [testCases, setTestCases] = useState(testCase)
  const setStoreTestCasesQuiz = useStore((state) => state.setTestCasesQuiz)
...
export default TestcaseInterfaceQuiz
