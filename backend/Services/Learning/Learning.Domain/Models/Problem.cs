...
public class Problem : Aggregate<ProblemId> {
    private readonly List<TestScript> _testScripts = new();
    public IReadOnlyList<TestScript> TestScripts => _testScripts.AsReadOnly();
    ...
    private readonly List<ProblemSubmission> _problemSubmissions = new();
    public IReadOnlyList<ProblemSubmission> ProblemSubmissions => _problemSubmissions.AsReadOnly();
